...
export function Menubar({ editor }: MenubarProps) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-1 bg-card p-2 border border-input border-x-0 border-t-0 rounded-t-lg">
      <TooltipProvider>
        ...
        <div className="mx-2 bg-border w-px h-6" />
        <div className="flex flex-wrap gap-1">
          <Tooltip>
            <TooltipTrigger asChild>
              <Toggle
